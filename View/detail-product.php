        ...
        <div class="container" id="box-detail-product">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <h4>Giá cũ: <del>13,960,000₫</del></h4>
                    <h4>Giá KM:
                        <p>15,390,000₫</p>
                    </h4>

                    <h5>Số lượng:</h5> <input type="number" value="1">
                    <a href="#" class="btn-buy-now"><span>Mua ngay</span></a>

                    <a href="#" class="btn-add-product"><span>Thêm vào giỏ hàng</span></a>
